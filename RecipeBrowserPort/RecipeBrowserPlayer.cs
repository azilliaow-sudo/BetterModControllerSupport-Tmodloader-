...
namespace ModdedControllerSupport
{
	...
	internal class RecipeBrowserPlayer : ModPlayer
	{
		...
		public override void ProcessTriggers(TriggersSet triggersSet)
		{
			...
			{
				if (ModdedControllerSupport.instance.ToggleRecipeBrowserHotKey.JustPressed)
				{
				...
				if (ModdedControllerSupport.instance.QueryHoveredItemHotKey.JustPressed)
				{
				...
				if (ModdedControllerSupport.instance.ToggleFavoritedPanelHotKey.JustPressed) {
