...
namespace ModdedControllerSupport
{
	...
	{
		internal static string RBText(string key, string category = "BestiaryUI") => ModdedControllerSupport.RBText(category, key);
		...
		internal UIElement CreateBestiaryPanel()
		{
			...
			BestiarySortRadioButton = new UIRadioButton(RBText("SortBestiary"), RBText("SortBestiaryTooltip"));
			IDSortRadioButton = new UIRadioButton(RBText("SortNPCID"), RBText("SortNPCIDTooltip"));
