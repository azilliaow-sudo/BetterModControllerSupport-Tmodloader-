...
namespace ModdedControllerSupport
{
	internal class UIRadioButton : UIText
	{
		...
		{
			this._toggleTexture = ModContent.Request<Texture2D>("Terraria/Images/UI/Settings_Toggle");
			text = "   " + text;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			spriteBatch.Draw(this._toggleTexture.Value, pos, new Rectangle?(value), disabled ? Color.Gray : Color.White, 0f, Vector2.Zero, Vector2.One, SpriteEffects.None, 0f);
