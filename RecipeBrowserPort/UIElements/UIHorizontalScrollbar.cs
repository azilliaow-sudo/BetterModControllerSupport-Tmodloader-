...
namespace ModdedControllerSupport.RecipeBrowserPort.UIElements
{
	public class UIHorizontalScrollbar : UIElement
	{
		...
		public UIHorizontalScrollbar()
		{
			...
			this._texture = ModdedControllerSupport.instance.Assets.Request<Texture2D>("RecipeBrowserPort/UIElements/ScrollbarHorizontal"); //TextureManager.Load("Terraria/Images/UI/Scrollbar");
			this._innerTexture = ModdedControllerSupport.instance.Assets.Request<Texture2D>("RecipeBrowserPort/UIElements/ScrollbarInnerHorizontal"); //TextureManager.Load("Terraria/Images/UI/ScrollbarInner");
			this.PaddingLeft = 5f;
