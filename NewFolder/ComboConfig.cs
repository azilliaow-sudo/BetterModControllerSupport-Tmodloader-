...
namespace ModdedControllerSupport.NewFolder
{
    ...
    public enum RightStickDirection
    {
        Up,
        Down,
        Left,
    ...
    public class QuickHealConfig : ModConfig
    {
        ...
        public RightStickDirection RightStickDirection { get; set; } = RightStickDirection.Right;
    ...
    public class ComboControllerSystem : ModSystem
    {
       
        private ulong lastQuickHealTick = 0UL;
        ...
        public override void PostUpdateEverything()
        {
            ...
            var cfg = ModContent.GetInstance<QuickHealConfig>();
            ...
            {
                TryTriggerQuickHeal(player);
                lastQuickHealTick = Main.GameUpdateCount;
            }
        }

        private void TryTriggerQuickHeal(Player player)
        {
